                    ...
                    <div class="summary-item">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            if (intval($mbrstr['mpstatus']) == 1 && $cfgtoken['disreflink'] != 1) {
                                ...
                                <li class="media">
                                    <div class="media-body">
                                        <div class="text-small"><?php echo myvalidate($LANG['g_refurl']); ?> <span class="text-small"><i class="fa fa-fw fa-external-link-alt"></i></span></div>
                                        <div class="media-title">
                                            <a href="<?php echo myvalidate($mysiteurl); ?>" target="_blank" data-toggle="tooltip" title="<?php echo myvalidate($mysiteurl); ?>">
                                                <span class="d-none d-sm-block"><?php echo myvalidate($mysiteurl); ?></span>
