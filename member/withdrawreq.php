...
if (isset($FORM['dosubmit']) && $FORM['dosubmit'] == '1' && $cfgtoken['diswithdraw'] != '1') {
    ...
    if ($txamount <= 0 || $txamount < $cfgtoken['minwalletwdr'] || $txamount > $cfgtoken['maxwalletwdr']) {
                ...
                <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <select name='txpaytype' class="custom-select" id="inputGroupSelect05" required="">
                                ...
                                if ($pgdatatokenarr['paystack4usr'] == 1) {
                                    ?>
                                    <option value="paystackpub">Paystack (<?php echo myvalidate($mbrpaystackcfg['paystackpub']) ? $mbrpaystackcfg['paystackpub'] : '...'; ?>)</option>
                                    <?php
                                }
                                if ($pgdatatokenarr['perfectmoney4usr'] == 1) {
                                    ?>
                                    <option value="perfectmoneyacc">Perfectmoney (<?php echo myvalidate($mbrperfectmoneycfg['perfectmoneyacc']) ? $mbrperfectmoneycfg['perfectmoneyacc'] : '...'; ?>)</option>
                                    <?php
                                }
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" <?php echo myvalidate($minwdrstr . ' ' . $maxwdrstr); ?> step="0.5" id="txamount" name="txamount" class="form-control" onChange="dowithdrawfee('<?php echo myvalidate($fval); ?>', '<?php echo myvalidate($fcapval); ?>', '<?php echo myvalidate($bpprow['currencysym']); ?>');" placeholder="0.00" required="">
                        </div>
