                                    ...
                                    <li>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" min="0" name="minwalletwdr" id="minwalletwdr" class="form-control" value="<?php echo myvalidate($cfgtoken['minwalletwdr']) ? $cfgtoken['minwalletwdr'] : '0'; ?>" placeholder="0">
                                                </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" min="0" name="maxwalletwdr" id="maxwalletwdr" class="form-control" value="<?php echo myvalidate($cfgtoken['maxwalletwdr']) ? $cfgtoken['maxwalletwdr'] : '0'; ?>" placeholder="0">
                                                </div>
                                                <div class="form-text text-muted">Leave 0 to disable (no limitation)</div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" min="0" name="wdrawfeemax" id="wdrawfeemax" class="form-control" value="<?php echo isset($wdrawfeemax) ? $wdrawfeemax : '0'; ?>" placeholder="0">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
